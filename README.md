...
Ferramentas digitais para análise e visualização de dados

Boas práticas em transformação digital no setor público
...
Profissionais interessados em inovação no setor público
...
│   ├── modulo-1-introducao
│   ├── modulo-2-lgpd-lai
│   ├── modulo-3-seguranca-informacao
│   ├── modulo-4-ferramentas-digitais
│   └── modulo-5-transformacao-digital
├── exercicios/
├── casos-praticos/
├── recursos/
│   ├── legislacao/
...
Turmas fechadas para órgãos públicos

Palestras e workshops presenciais ou online
...
Isso significa que você pode compartilhar e adaptar, desde que cite a fonte, não use para fins comerciais e mantenha a mesma licença.
...
🔁 Compartilhe com colegas servidores

📣 Divulgue em suas redes

Juntos, podemos transformar o serviço público por dentro.
